  ...
  return (
    <div className='container'>
      <div className='top'>
        ...
        <p id='top'>Use the Menu to select different stylesheets</p>
      </div>
      <div className='main'>
        <div className='btn'>
          <Link to="/" className='link1'><button id='btn1'>Stylesheet 1</button></Link>
          <Link to="/stylesheet2" className='link1'><button id='btn2' className='btn-1'>Stylesheet 2</button></Link>
          <Link to="/stylesheet3" className='link1'><button id='btn3' className='btn-1'>Stylesheet 3</button></Link>
          <Link to="/stylesheet4" className='link1'><button id='btn4' className='btn-1'>Stylesheet 4</button></Link>
          <Link to="/NoStylesheet" className='link1'><button id='btnNo' className='btn-1'>No Style</button></Link>
        </div>
        <div className='body-1'>
          ...
          <p>
            ...
            <a href="NoStylesheet">No Stylesheet</a>
          </p>
        </div>
